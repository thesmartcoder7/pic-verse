  ...
  constructor(options) {
    ...
    const pickerWidth = this.options.width
      ? this.options.closeButton
        ...
        : this.options.width
      : 370;
    const pickerHeight = this.options.height && this.options.height > 370
      ? this.options.height
      : 370;
    ...
    const categoryFlags = {
      People: `${this.options.navButtonSvg.button1
      ...
      Nature: `${this.options.navButtonSvg.button2
      ...
      "Food-dring": `${this.options.navButtonSvg.button3
      ...
      Activity: `${this.options.navButtonSvg.button4
      ...
      "Travel-places": `${this.options.navButtonSvg.button5
      ...
      Objects: `${this.options.navButtonSvg.button6
      ...
      Symbols: `${this.options.navButtonSvg.button7
      ...
      Flags: `${this.options.navButtonSvg.button8
    ...
    if (this.options.addEmoji.pickerTab &&
    ...
    const functions = {
      styles: () => {
        const styles = `
                <style>
                    :root {
                        --icon-background: ${this.options.color.pickerBackground
            ? this.options.color.pickerBackground
            : "#ffffff"};
                        --icon-hover: ${this.options.color.iconHoverColor
            ? this.options.color.iconHoverColor
            : "#ebebeb"};
                        --text-color: ${this.options.color.foreground
            ? this.options.color.foreground
            : "#666"};
                        --border-color: ${this.options.color.borderColor
            ? this.options.color.borderColor
            : "#ededed"};
                        --search-background: ${this.options.color.searchBackground
            ? this.options.color.searchBackground
            : "#f3f3f3"};
                        --nav-background: ${this.options.color.navbarColor
            ? this.options.color.navbarColor
            : "#646772"};
                        --nav-button-hover: ${this.options.color.navButtonHoverBG
            ? this.options.color.navButtonHoverBG
            : "#e9ebf1"};
                        --nav-button-active: ${this.options.color.navButtonActiveBG
            ? this.options.color.navButtonActiveBG
            : "#e9ebf1"};
                        --nav-Svg-fill: ${this.options.color.navSvgFill
            ...
            : ""}
                    ...
                    .fg-picker-special-buttons a {
                        background-color: ${this.options.color.closeMoveButtonColor
          ...
          (this.options.disableNav ? 41 : 0)}px;
                        position: fixed;
                        width: ${pickerWidth}px;
                        min-width: 370px;
                    }
                    ...
                    .fg-emoji-list li {
                        ...
                        justify-content: center;
                        align-items: center;
                        flex: 0 0 calc(100% / ${this.options.emojiDim.emojiPerRow
            ? this.options.emojiDim.emojiPerRow
            : 6});
                        height: ${this.options.emojiDim.emojiButtonHeight
            ...
            : 50}px;
                    ...
                    .fg-emoji-list li a {
                        ...
                        justify-content: center;
                        align-items: center;
                        font-size: ${this.options.emojiDim.emojiSize
            ...
            : ""}
                    ${this.options.hiddenScrollBar
            ? `.fg-emoji-list { scrollbar-width: none;}`
            : ""}
